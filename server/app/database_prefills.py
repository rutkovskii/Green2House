from models import User, DataSample
import utils as u
...
prefill_users = [
        User(name='Mike Green', phone_number='+55555', email='mike@umass.edu', auth_token='12345'),
        User(name='Rob Green', phone_number='+44444', email='rob@umass.edu', auth_token='12345'),
        User(name='John Green', phone_number='+33333', email='john@umass.edu', auth_token='12345'),
        User(name='Cole Green', phone_number='+33333', email='cole@umass.edu', auth_token='12345'),
    ]
