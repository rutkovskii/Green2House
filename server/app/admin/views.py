...
@admin_bp.route(AdminConfig.ADMIN_DATA_SAMPLES_ROUTE, methods=["GET"])
@login_required
@admin_required
...
@admin_bp.route(AdminConfig.ADMIN_PAGE_ROUTE)
@login_required
@admin_required
...
@admin_bp.route(AdminConfig.ADMIN_PAGE_USERS_ROUTE)
@login_required
@admin_required
...
@admin_bp.route(AdminConfig.ADMIN_PAGE_SERVE_USERS_ROUTE, methods=["GET"])
@login_required
@admin_required
def serve_users():
